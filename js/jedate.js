	...
	*/
    ...
    InitDate.prototype = {
        ...
        setHtml:function(opts, self) {
            ...
            var bothmsStr = !isformat ? '<ul class="botflex jedatehms"><li></li></ul>' + '<div class="botflex jedatebtn"><span class="jedateclear" style="width:0%;">清空</span><span class="jedatetodaymonth" style="width:0%;"></span><span class="jedateok" style="width:31%;">取消</span></div>' :'<div class="botflex jedatebtn"><span class="jedateclear" style="width:31%;">清空</span><span class="jedatetodaymonth" style="width:31%;">本月</span><span class="jedateok" style="width:31%;">确认</span></div>';
        ...
        events:function(that, opts, self, arrTime) {
            ...
            //点击确认处隐藏
            jeDt.on(".jedateok", "click", function() {
                jeDt.shdeCell(true);
                jeDt.html(QD(Cell)[0], "");
            });
...
//              jetopym.style.display = "block";
        ...
        clickLiDays:function(that, opts, self) {
            jeDt.each(QD(Cell + " .jedaul li"), function(i, cls) {
                jeDt.on(cls, "click", function(ev) {
                	//alert($(this).attr('data-y'))
                	openWebview('code_detail.html',{date:"20170227"})
